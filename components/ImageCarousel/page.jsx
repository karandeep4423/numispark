...
//         className="absolute left-1 bottom-1/2 transform -translate-y-1/2 bg-blue-300 hover:bg-blue-600 text-white p-2 rounded-full disabled:opacity-50"
//       >
//         {"<"}
//       </button>
//       <button
...
//         className="absolute right-1 bottom-1/2 transform -translate-y-1/2 bg-blue-300 hover:bg-blue-600 text-white p-2 rounded-full"
//       >
//         {">"}
//       </button>
